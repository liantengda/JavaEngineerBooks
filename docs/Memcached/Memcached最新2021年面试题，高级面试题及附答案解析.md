...
### [8、Memcached是原子的吗？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Memcached/Memcached最新2021年面试题，高级面试题及附答案解析.md#8memcached是原子的吗)  
...
### [9、Memcached能够更有效地使用内存吗？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Memcached/Memcached最新2021年面试题，高级面试题及附答案解析.md#9memcached能够更有效地使用内存吗)  
...
### [10、Memcached的内存分配器是如何工作的？为什么不适用malloc/free！？为何要使用slabs？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Memcached/Memcached最新2021年面试题，高级面试题及附答案解析.md#10memcached的内存分配器是如何工作的为什么不适用malloc/free为何要使用slabs)  
