...
![](http://shasengbufa.com/dataAccess.png)


### [8、什么是微服务中的反应性扩展？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Spring/Spring高级面试题及答案，2021版.md#8什么是微服务中的反应性扩展)  
...
### [9、比较一下 Spring Security 和 Shiro 各自的优缺点 ?](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Spring/Spring高级面试题及答案，2021版.md#9比较一下-spring-security-和-shiro-各自的优缺点-)  
...
### [10、使用 Spring 访问 Hibernate 的方法有哪些？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Spring/Spring高级面试题及答案，2021版.md#10使用-spring-访问-hibernate-的方法有哪些)  
