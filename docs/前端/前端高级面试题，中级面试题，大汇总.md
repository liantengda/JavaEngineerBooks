...
### [8、静态网页和动态网页区别：](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/前端/前端高级面试题，中级面试题，大汇总.md#8静态网页和动态网页区别：)  
...
### [9、压缩合并目的？http请求的优化方式？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/前端/前端高级面试题，中级面试题，大汇总.md#9压缩合并目的http请求的优化方式)  
...
### [10、展开(spread )运算符和 剩余(Rest) 运算符有什么区别？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/前端/前端高级面试题，中级面试题，大汇总.md#10展开spread-运算符和-剩余rest-运算符有什么区别)  
