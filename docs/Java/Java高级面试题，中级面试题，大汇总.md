...
### [8、解释内存中的栈(stack)、堆(heap)和方法区(method area)的用法。](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java高级面试题，中级面试题，大汇总.md#8解释内存中的栈stack堆heap和方法区method-area的用法。)  
...
### [9、多线程同步有哪几种方法？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java高级面试题，中级面试题，大汇总.md#9多线程同步有哪几种方法)  


Synchronized关键字，Lock锁实现，分布式锁等。


### [10、什么是自旋](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java高级面试题，中级面试题，大汇总.md#10什么是自旋)  
