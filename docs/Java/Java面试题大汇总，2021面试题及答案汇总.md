...
### [8、接口和抽象类有什么区别？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java面试题大汇总，2021面试题及答案汇总.md#8接口和抽象类有什么区别)  
...
### [9、原型模式的应用场景](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java面试题大汇总，2021面试题及答案汇总.md#9原型模式的应用场景)  
...
### [10、ConcurrentHashMap 和 Hashtable 的区别？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java面试题大汇总，2021面试题及答案汇总.md#10concurrenthashmap-和-hashtable-的区别)  
...
![](http://shasengbufa.com/hashTable.png)

**2、**  JDK1.7的ConcurrentHashMap

![](http://shasengbufa.com/HashMap7.png)

**3、** JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）

![](http://shasengbufa.com/hashMap8.png)
