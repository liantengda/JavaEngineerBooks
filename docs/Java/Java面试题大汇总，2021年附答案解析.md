...
### [8、面向对象的特征有哪些方面？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java面试题大汇总，2021年附答案解析.md#8面向对象的特征有哪些方面)  
...
### [9、是否了解连接池，使用连接池有什么好处？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java面试题大汇总，2021年附答案解析.md#9是否了解连接池使用连接池有什么好处)  
...
### [10、JVM 选项 -XX:+UseCompressedOops 有什么作用？为什么要使用](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Java/Java面试题大汇总，2021年附答案解析.md#10jvm-选项--xx:+usecompressedoops-有什么作用为什么要使用)  
