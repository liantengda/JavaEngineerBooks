...
### [8、你能保证 GC 执行吗？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/并发编程/并发编程高级面试题合集，附答案解析.md#8你能保证-gc-执行吗)  


不能，虽然你可以调用 System.gc() 或者 Runtime.gc()，但是没有办法保证 GC的执行。


### [9、说说G1垃圾收集器的工作原理](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/并发编程/并发编程高级面试题合集，附答案解析.md#9说说g1垃圾收集器的工作原理)  
...
### [10、并行和并发有什么区别？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/并发编程/并发编程高级面试题合集，附答案解析.md#10并行和并发有什么区别)  
