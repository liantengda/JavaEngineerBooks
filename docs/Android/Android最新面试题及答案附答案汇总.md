...
### [8、你一般在开发项目中都使用什么设计模式？如何来重构，优化你的代码？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Android/Android最新面试题及答案附答案汇总.md#8你一般在开发项目中都使用什么设计模式如何来重构优化你的代码)  
...
### [9、描述一下android的系统架构](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Android/Android最新面试题及答案附答案汇总.md#9描述一下android的系统架构)  
...
### [10、如何将SQLite数据库(dictionary.db文件)与apk文件一起发布](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Android/Android最新面试题及答案附答案汇总.md#10如何将sqlite数据库dictionarydb文件与apk文件一起发布)  
