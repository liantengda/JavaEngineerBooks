...
### [8、类的实例化顺序](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Jvm/Jvm最新2021年面试题，高级面试题及附答案解析.md#8类的实例化顺序)  
...
### [9、工作中常用的 JVM 配置参数有哪些？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Jvm/Jvm最新2021年面试题，高级面试题及附答案解析.md#9工作中常用的-jvm-配置参数有哪些)  
...
### [10、Java里有哪些引用类型？](https://github.com/liantengda/JavaEngineerBooks/blob/master/docs/Jvm/Jvm最新2021年面试题，高级面试题及附答案解析.md#10java里有哪些引用类型)  
